...
Impact of current trends, e.g., GenAI/AgenticAI? (Though I don't have any further specific questions here than what we already discuss above)
...
How do we ensure that our (synthetic and/or static, i.e., unchanged over multiple years) benchmarks and datasets/problem sets are relevant to practitioners?

\subsection{Future-Proof Reproducibility Practices}

Large-scale reproducibility? Can we ensure that previously achieved results remain valid in the future? How do we encourage good reproducibility practices? (In my experience it's still not too common to get really reproducible results...)
