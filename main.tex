...
\author{Theresa Eimer$^{1,2}$ \and Lennart Schäpermeier$^3$ \and André Biedenkapp$^4$ \and Alexander Tornede \and Lars Kotthoff$^5$ \and Pieter Leyman$^6$ \and Matthias Feurer$^7$\and Katharina Eggensperger$^7$ \and Kaitlin Maile$^8$ \and Tanja Tornede \and Anna Kozak$^9$ \and Ke Xue$^{10}$ \and Marcel Wever$^{1,2}$ \and Mitra Baratchi$^{11}$ \and Damir Pulatov$^{12}$ \and Heike Trautmann$^{13}$ \and Haniye Kashgarani$^{14}$ \and Marius Lindauer$^{1,2}$}
\date{\small $^1$Leibniz University Hannover, $^2$L3S Research Center, $^3$University of Münster, $^4$Albert-Ludwigs University Freiburg, $^5$University of St. Andrews, $^6$Ghent University, $^7$Dortmund University, $^8$Google, $^9$Warsaw University of Technology, $^{10}$Nanjing University, $^{11}$Leiden University, $^{12}$University of North Carolina Wilmington, $^{13}$Paderborn University, $^{14}$Purdue University}
